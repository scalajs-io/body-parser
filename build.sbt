...
lazy val root = (project in file(".")).
  ...
  settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.scalajs.npm" %%% "express" % "4.14.1-2"
  ))
...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/ldaniels528/scalajs-node-npm</url>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/body-parser.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/body-parser.git</developerConnection>
        <url>github.com/scalajs-io/body-parser.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
